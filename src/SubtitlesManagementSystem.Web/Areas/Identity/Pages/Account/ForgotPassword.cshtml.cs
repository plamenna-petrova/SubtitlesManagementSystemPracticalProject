...
namespace SubtitlesManagementSystem.Web.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        /// </summary>
        [BindProperty]
        public ForgotPasswordBindingModel ForgotPasswordBinding { get; set; }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                var userByEmail = await _userManager.FindByEmailAsync(ForgotPasswordBinding.Email);
